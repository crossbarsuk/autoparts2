...
class Blockcontactinfos extends Module
{
	...
	public function install()
	{
		return (parent::install() 
				...
				&& Configuration::updateValue('blockcontactinfos_person', Configuration::get('PS_SHOP_CONTACT_PERSON'))
				&& Configuration::updateValue('blockcontactinfos_worktime', Configuration::get('PS_SHOP_WORK_TIME'))
	...
	public function uninstall()
	{
		...
		return (Configuration::deleteByName('blockcontactinfos_company') 
				...
				&& Configuration::deleteByName('blockcontactinfos_person') && Configuration::deleteByName('blockcontactinfos_phone')
				&& Configuration::deleteByName('blockcontactinfos_worktime') && Configuration::deleteByName('blockcontactinfos_phone')
	...
	public function getContent()
	{
		...
		{	
			...
			Configuration::updateValue('blockcontactinfos_person', ((isset($_POST['person']) && $_POST['person'] != '') ? $_POST['person'] : Configuration::get('PS_SHOP_CONTACT_PERSON')));
			Configuration::updateValue('blockcontactinfos_worktime', ((isset($_POST['work']) && $_POST['work'] != '') ? $_POST['work'] : Configuration::get('PS_SHOP_WORK_TIME')), true);
		...
		<form action="'.Tools::htmlentitiesutf8($_SERVER['REQUEST_URI']).'" method="post">
			<fieldset>	
				...
				<p><label for="person">'.$this->l('Contact').' :</label>
				<input type="text" id="person" name="person" value="'.Tools::safeOutput(Configuration::get('blockcontactinfos_person')).'" />	</p>
				<p><label for="work">'.$this->l('Work time').' :</label>
				<textarea id="work" name="work" cols="60" rows="4">'.Configuration::get('blockcontactinfos_worktime').'</textarea></p>
	...
	{	
		if (!$this->isCached('blockcontactinfos.tpl', $this->getCacheId()))
			$this->smarty->assign(array(
				...
				'blockcontactinfos_person' => Configuration::get('blockcontactinfos_person'),
				'blockcontactinfos_worktime' => Configuration::get('blockcontactinfos_worktime'),
			));
