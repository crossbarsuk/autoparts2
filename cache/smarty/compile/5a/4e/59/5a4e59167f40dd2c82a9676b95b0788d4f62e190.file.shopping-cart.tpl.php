<?php /* Smarty version Smarty-3.1.14, created on 2014-02-21 14:23:40
         compiled from "/home/pavel/public_html/clients/autoparts/themes/autoparts/shopping-cart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8628100295307087c2acf30-77179013%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5a4e59167f40dd2c82a9676b95b0788d4f62e190' => 
    array (
      0 => '/home/pavel/public_html/clients/autoparts/themes/autoparts/shopping-cart.tpl',
      1 => 1392985418,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '8628100295307087c2acf30-77179013',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.14',
  'unifunc' => 'content_5307087cbb2160_21778220',
  'variables' => 
  array (
    'account_created' => 0,
    'empty' => 0,
...
<?php if ($_valid && !is_callable('content_5307087cbb2160_21778220')) {function content_5307087cbb2160_21778220($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/home/pavel/public_html/clients/autoparts/tools/smarty/plugins/modifier.escape.php';
?><div class="block">
<?php $_smarty_tpl->_capture_stack[0][] = array('path', null, null); ob_start(); ?><?php echo smartyTranslate(array('s'=>'Ваш заказ:'),$_smarty_tpl);?>
...
<h1 id="cart_title"><?php echo smartyTranslate(array('s'=>'Ваш заказ:'),$_smarty_tpl);?>
</h1>
...
<?php if (isset($_smarty_tpl->tpl_vars['empty']->value)){?>
  <div class="empty_cart">
    <img alt="cart_ico" src="/themes/autoparts/img/cart.png">
    <div>
      <b><?php echo smartyTranslate(array('s'=>'Your shopping cart is empty.'),$_smarty_tpl);?>
</b>
      <img alt="min cart" src="/themes/autoparts/img/min_cart_ico.png">
      <p><?php echo smartyTranslate(array('s'=>'Для добавления деталей в корзину нажмите на ссылку с изображением корзины в таблице результатов поиска .'),$_smarty_tpl);?>
 </p>
    </div>
  </div>
...
<?php }?>
<p style="display: none"><?php echo smartyTranslate(array('s'=>'Your shopping cart contains:'),$_smarty_tpl);?>
		...
		<?php if ($_smarty_tpl->tpl_vars['use_taxes']->value){?>
			<?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value){?>
				<tr class="cart_total_price">
					<td colspan="6"><?php if ($_smarty_tpl->tpl_vars['display_tax_label']->value){?><?php echo smartyTranslate(array('s'=>'Total products (tax excl.)'),$_smarty_tpl);?>
...
<?php }?></td>
			...
			<?php }else{ ?>
				<tr class="cart_total_price">
					<td colspan="6"><?php if ($_smarty_tpl->tpl_vars['display_tax_label']->value){?><?php echo smartyTranslate(array('s'=>'Total products (tax incl.)'),$_smarty_tpl);?>
<?php }else{ ?><?php echo smartyTranslate(array('s'=>'Total products'),$_smarty_tpl);?>
<?php }?></td>
...
<?php }?>
			...
			<?php if ($_smarty_tpl->tpl_vars['total_shipping_tax_exc']->value<=0&&!isset($_smarty_tpl->tpl_vars['virtualCart']->value)){?>
				<tr class="cart_total_delivery" style="<?php if (!isset($_smarty_tpl->tpl_vars['carrier']->value->id)||is_null($_smarty_tpl->tpl_vars['carrier']->value->id)){?>display:none;<?php }?>">
					<td colspan="6"><?php echo smartyTranslate(array('s'=>'Shipping'),$_smarty_tpl);?>
</td>
				...
				<?php if ($_smarty_tpl->tpl_vars['use_taxes']->value&&$_smarty_tpl->tpl_vars['total_shipping_tax_exc']->value!=$_smarty_tpl->tpl_vars['total_shipping']->value){?>
					<?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value){?>
						<tr class="cart_total_delivery" <?php if ($_smarty_tpl->tpl_vars['total_shipping_tax_exc']->value<=0){?> style="display:none;"<?php }?>>
							<td colspan="6"><?php if ($_smarty_tpl->tpl_vars['display_tax_label']->value){?><?php echo smartyTranslate(array('s'=>'Total shipping (tax excl.)'),$_smarty_tpl);?>
...
<?php }?></td>
					...
					<?php }else{ ?>
						<tr class="cart_total_delivery"<?php if ($_smarty_tpl->tpl_vars['total_shipping']->value<=0){?> style="display:none;"<?php }?>>
							<td colspan="6"><?php if ($_smarty_tpl->tpl_vars['display_tax_label']->value){?><?php echo smartyTranslate(array('s'=>'Total shipping (tax incl.)'),$_smarty_tpl);?>
<?php }else{ ?><?php echo smartyTranslate(array('s'=>'Total shipping'),$_smarty_tpl);?>
<?php }?></td>
...
<br />
        ...
        <td class="total_price_container"><?php echo smartyTranslate(array('s'=>'Total'),$_smarty_tpl);?>
 </td>
				<?php if ($_smarty_tpl->tpl_vars['use_taxes']->value){?>
...
<?php }?>" class="gray-btn" title="<?php echo smartyTranslate(array('s'=>'Continue shopping'),$_smarty_tpl);?>
