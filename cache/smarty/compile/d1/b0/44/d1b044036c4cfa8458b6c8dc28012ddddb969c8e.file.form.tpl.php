<?php /* Smarty version Smarty-3.1.14, created on 2014-02-25 11:04:14
         compiled from "/home/pavel/public_html/clients/autoparts/admin2605/themes/default/template/controllers/import/helpers/form/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2084249803530c5c8e774de4-98115596%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd1b044036c4cfa8458b6c8dc28012ddddb969c8e' => 
    array (
      0 => '/home/pavel/public_html/clients/autoparts/admin2605/themes/default/template/controllers/import/helpers/form/form.tpl',
      1 => 1392817950,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2084249803530c5c8e774de4-98115596',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_530c5c8e9954c6_00315553',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_530c5c8e9954c6_00315553')) {function content_530c5c8e9954c6_00315553($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/home/pavel/public_html/clients/autoparts/tools/smarty/plugins/modifier.escape.php';
?>
...
"Ipod;red.jpg<span class="bold" style="color: red">,</span>blue.jpg<span class="bold" style="color: red">,</span>green.jpg;129.90"
 ...
 <span id="entitie"><?php echo smartyTranslate(array('s'=>'categories'),$_smarty_tpl);?>
      ...
      <label for="supplier_name" class="clear"><?php echo smartyTranslate(array('s'=>'Supplier name'),$_smarty_tpl);?>
</label>
      <div class="margin-form">
...
<?php }else{ ?>,<?php }?>');
      ...
      if ($.trim($("#entity > option:selected").text()) == 'Tecdoc') {
        $("label[for=supplier_name], #supplier_name").show();
        $("label[for=match_ref], #match_ref").show();
        $("#match_ref").prop('checked', true);
      } else {
        $("label[for=supplier_name], #supplier_name").hide();
      }
