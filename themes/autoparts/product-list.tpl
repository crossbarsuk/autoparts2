        ...
        <div class="img_wrap">
          <a href="{$product.link|escape:'htmlall':'UTF-8'}" class="product_img_link" title="{$product.name|escape:'htmlall':'UTF-8'}">
            ...
            {if isset($product.new) && $product.new == 1}<span class="new">{l s='New'}</span>{/if}
				...
				<p class="product_desc"><a href="{$product.link|escape:'htmlall':'UTF-8'}" title="{$product.description_short|strip_tags:'UTF-8'|truncate:100:'...'}" >{$product.description_short|strip_tags:'UTF-8'|truncate:50:'...'}</a></p>
			</div>
